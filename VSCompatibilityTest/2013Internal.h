...
#ifdef _CRT_APP
	_CRTIMP void __cdecl _exit_app(void);   /* crt0dat.c */
#endif  /* _CRT_APP */
...
#if !defined (_CRT_APP) || defined (_KERNELX) || defined (_DEBUG)
...
#define _ERRCHECK_SPRINTF(_PrintfCall) \
	...
	BOOL __cdecl __copy_to_char(const wchar_t* inString, char** outString);
